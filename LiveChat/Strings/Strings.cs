...
namespace LiveChat.Strings
{
    public class Strings
    {
        ...
        public const string ProfitText1 = "WebSockets provide fast delivery of messages. Your customers do not have to wait long. Everything depends only on the speed of the operators";
